---
title: An x words/day habit optimizes for output, not quality
subtitle: 
date started: 2025-08-16
date finished: 2025-08-16
tags:
  - blog/post
source: https://seanmcloughl.in/an-x-wordsday-habit-optimizes-for-output-not-quality/
---
Today I learned about the [Inkhaven Residency](https://www.inkhaven.blog/)[^1] which is currently accepting applications. During the residency, you are tasked with writing a new blog post every day. I thought that it might be interesting to apply for it, even if it does not make sense given my time and financial constraints. So I clicked on the application form. Of course, the application asks for you to submit 1-5 pieces of writing that you're proud of. 
